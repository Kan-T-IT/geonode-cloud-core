...
from geonode.geoserver.acl.gsauth_client import models
from geonode.geoserver.acl.gsauth_client import rest
from geonode.geoserver.acl.gsauth_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gsauth_client.models, klass)
